              ...
              ListFooterComponent={() => (
                <View style={styles.listFooter}>
                  ...
                  <View style={styles.inviteContainer}>
                    <TextInput style={[styles.input, styles.inviteInput]} placeholder="USER NAME"/>
                  ...
                  <View style={styles.inviteContainer}>
                    <TextInput style={[styles.input, styles.inviteInput]} placeholder="COST CODE"/>
                  ...
                  <View style={styles.inviteContainer}>
                    <TextInput style={[styles.input, styles.inviteInput]} placeholder="0"/>
